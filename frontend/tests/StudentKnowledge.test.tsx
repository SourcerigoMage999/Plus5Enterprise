...
const snapshot = {
  ...
  models: [{
    ...
    areas: [
      { knowledgeAreaId: 'area-1', name: 'Grammar', sortOrder: 1, score: 0.74, confidence: 'Medium', readiness: 'Developing', evidenceCount: 3, effectiveEvidenceWeight: 2.4, calculatedAtUtc: '2026-09-26T10:00:00Z', algorithmVersion: 'readiness-v1', components: [component] },
...
describe('student knowledge detail', () => {
  it('renders real component projections and switches model-defined areas', async () => {
    ...
    expect(screen.getByRole('rowheader', { name: 'Past Simple' })).toBeInTheDocument()
    ...
    const row = screen.getByRole('rowheader', { name: 'Main idea' }).closest('tr')
